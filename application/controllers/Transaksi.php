...
class Transaksi extends ci_controller{
        ...
        parent::__construct();
        $this->load->model(array('model_transaksi','model_penjualan','model_pengiriman'));
        chek_session();
    }
    ...
    function index()
    {
        ...
        {
            $this->model_transaksi->simpan_paket_detail();
            redirect('transaksi');
        }
        else
        {
           
            $data['penjualan']=  $this->model_penjualan->tampilkan_data();
            $data['pengiriman']=$this->model_pengiriman->tampilkan_data();
            $data['detail']= $this->model_transaksi->tampilkan_paket_detail()->result();
            $this->template->load('template','transaksi/form_transaksi',$data);
        }
    }
    

    // MENAMBAHAKAN FUNCTION PENJUALAN
